...
**Задача:** оформити готове deep-research дослідження як wiki-сторінку `wiki/concepts/hybrid-rag-search.md` (Brain-вault) — **відкладено**. Дистильовані висновки лишаю тут, щоб не загубити (сирий звіт був у ефемерному воркфлоу-транскрипті).
