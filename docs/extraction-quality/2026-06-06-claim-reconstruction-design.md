...
- **Мова — українська** (нормалізована: RU-пост → UA-claim — так фактично поводиться модель; рішення прийнято після валідації doc 20). Узгоджено з мовою верифікатора/RAG.
...
1. Перевитягти doc 20 → очікую 1–2 реконструйованих claim-и українською з вірною полярністю, без фрагментів.
